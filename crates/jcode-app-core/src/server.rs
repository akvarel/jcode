...
impl Server {
    ...
    fn spawn_background_tasks(
        ...
        let watchdog_swarm_plans = Arc::clone(&self.swarm_state.plans);
        let watchdog_swarm_coordinators = Arc::clone(&self.swarm_state.coordinators);
        let watchdog_swarm_members = Arc::clone(&self.swarm_state.members);
        tokio::spawn(async move {
